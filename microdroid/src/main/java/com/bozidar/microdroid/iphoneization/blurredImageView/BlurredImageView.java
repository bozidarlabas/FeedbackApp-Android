package com.bozidar.microdroid.iphoneization.blurredImageView;
...
public class BlurredImageView extends ImageView {
    ...
    private void init(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(
                attrs,
                R.styleable.BlurredImageView);

        this.radius = a.getInteger(R.styleable.BlurredImageView_radius, 0);
